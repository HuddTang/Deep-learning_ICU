...
# model.load_data(data,{'e':e, 't':t})
# model.generate_graph()
# model.train(data_test,{'e':e_test, 't':t_test}, data_valid,{'e':e_valid, 't':t_valid}, num_epoch=1000, iteration=1)

model.load_model()

model.get_vip_byweights()
# hx, ci = model.score_expand(data_test, {'e': e_test, 't': t_test})
# print(ci)
# print(hx)
# with open('./result_test.json','w') as f:
#     json.dump(hx.tolist(), f)
model.close()
